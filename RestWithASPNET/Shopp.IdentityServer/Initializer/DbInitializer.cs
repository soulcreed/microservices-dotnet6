...
namespace Shopp.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "jeferson.almeida@hotmail.com",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Shop123$").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "Shop123$").GetAwaiter().GetResult();
